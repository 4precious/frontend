      ...
      <ScrollView>
        <View
          ...
          <Text
            ...
            <Text style = {{backgroundColor:'rgba(255,194,38,0.2)',fontWeight:'500'}}>우선 아이가 책상에 앉으면 눈앞에 보이는 물건이 없어야 합니다.</Text>
            책상에 책꽂이도 두지 않는 것이 좋아요.
            눈앞에 보이는 책만으로도 끊임없이 상상의 나래를 펴거든요.
            책상도 되도록 아무것도 없이 비워 두는 것이 좋습니다.{'\n'}{'\n'}
            <Text style = {{backgroundColor:'rgba(255,194,38,0.2)',fontWeight:'500'}}>아이 방 자체도 심플해야 해요.</Text>
            장식품이 많거나 벽지가 화려해도 집중하는데 방해가 됩니다.{'\n'}{'\n'}
            <Text style = {{backgroundColor:'rgba(255,194,38,0.2)',fontWeight:'500'}}>당연히 컴퓨터나 스마트폰은 아이방이 아니라 거실에 두어야합니다.</Text>
            상황이 안된다면 최소한 책상 앞에 앉았을 때 보이지 않는 위치에 두세요.{'\n'}{'\n'}
            잡생각이 많은 아이들은 시끄러워도 집중이 안됩니다.
            거실에서 부모가 소곤소곤 이야기하는 소리만 들려도 그쪽으로 귀가 열려서 집중할 수 없어요.
            <Text style = {{backgroundColor:'rgba(255,194,38,0.2)',fontWeight:'500'}}>아이가 공부한다고 앉으면 부모는 전화통화나 TV를 보는 것도 삼가는 것이 좋아요</Text>{'\n'}{'\n'}
            아이가 주변을 정리한다음, 공부를 시작할 때는 부모가 간단하게는 공부할 내용의 개요와 단계를 설명해주세요. 
            뭘 하기 위해 책상 위에 앉은 것인지 확인시키는 것이죠. <Text style = {{backgroundColor:'rgba(255,194,38,0.2)',fontWeight:'500'}}>아이에게 단기목표를 설정해 주는 겁니다. </Text>
